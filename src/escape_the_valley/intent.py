...
class IntentAction(StrEnum):
    ...
    ABANDON_CARGO = "ABANDON_CARGO"
    DESPERATE_REPAIR = "DESPERATE_REPAIR"
    HARD_RATION = "HARD_RATION"
    LEDGER_ENABLE = "LEDGER_ENABLE"
    LEDGER_DISABLE = "LEDGER_DISABLE"
    LEDGER_SETTLE = "LEDGER_SETTLE"
    PARCEL_ACCEPT = "PARCEL_ACCEPT"
    PARCEL_REFUSE = "PARCEL_REFUSE"
